...
## 3.18.0 - 2026-02-13
### Features
* Updated the allowed range for the [`trackingInterval`](https://developers.kameleoon.com/feature-management-and-experimentation/web-sdks/python-sdk/#additional-configuration). The new range is from **`1000` ms** (default) to **`5000` ms**, allowing a reduction in the number of tracking requests.
